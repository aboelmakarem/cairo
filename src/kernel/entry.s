...
entry:
	...
	csrw mideleg, t1
	csrw medeleg, t1
	# 9. Set the machine mode trap vector location to timer_trap and 
	# the supervisor mode trap vector location to trap_vector
	la t2, timer_trap
	csrw mtvec,t2
	la t2, trap_vector
	csrw stvec,t2
...
enter_kernel_main:
	# call the start function, this call never returns
	call start
